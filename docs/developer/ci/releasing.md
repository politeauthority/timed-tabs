...
4. Runs the **E2E scenarios in Firefox stable and stable-1 and in Chrome stable** against it, the
   scenarios that gate a pull request. Nothing is built or published until they pass.
